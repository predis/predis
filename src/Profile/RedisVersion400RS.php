...
/**
 * Server profile for Redis 4.0. with Redisearch
 *
 * @author Daniele Alessandri <suppakilla@gmail.com>
 */
class RedisVersion400RS extends RedisProfile {
	/**
	 * {@inheritdoc}
	 */
	...
	public function getSupportedCommands()
	{
		return array(
			...
			/* ---------------- Redis 4.0 with Redisearch ---------------- */
			/* commands performing redisearch (1.2.0) operations */
			'FTCREATE'          => 'Predis\Command\FtCreate',
			'FTADD'             => 'Predis\Command\FtAdd',
			'FTADDHASH'         => 'Predis\Command\FtAddHash',
			'FTALTER'           => 'Predis\Command\FtAlter',
			'FTINFO'            => 'Predis\Command\FtInfo',
			'FTSEARCH'          => 'Predis\Command\FtSearch',
			'FTAGGREGATE'       => 'Predis\Command\FtAggregate',
			'FTEXPLAIN'         => 'Predis\Command\FtExplain',
			'FTDEL'             => 'Predis\Command\FtDel',
			'FTGET'             => 'Predis\Command\FtGet',
			'FTMGET'            => 'Predis\Command\FtMget',
			'FTDROP'            => 'Predis\Command\FtDrop',
			'FTAGVALS'          => 'Predis\Command\FtTagvals',
			'FTSUGADD'          => 'Predis\Command\FtSugadd',
			'FTSUGGET'          => 'Predis\Command\FtSugget',
			'FTSUGDEL'          => 'Predis\Command\FtSugdel',
			'FTSUGLEN'          => 'Predis\Command\FtSuglen',
			'FTSYNADD'          => 'Predis\Command\FtSynadd',
			'FTSYNUPDATE'       => 'Predis\Command\FtSynupdate',
			'FTSYNDUMP'         => 'Predis\Command\FtSyndump',
		);
	}
}
