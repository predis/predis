 ...
 * @method $this brpoplpush(string $source, string $destination, int|float $timeout)
 * @method $this lcs(string $key1, string $key2, bool $len = false, bool $idx = false, int $minMatchLen = 0, bool $withMatchLen = false)
 * @method $this lindex(string $key, $index)
 * @method $this linsert(string $key, $whence, $pivot, $value)
 * @method $this llen(string $key)
 ...
 * @method $this lpop(string $key)
 * @method $this lpush(string $key, string ...$values)
 * @method $this lpushx(string $key, string ...$values)
 * @method $this lrange(string $key, $start, $stop)
 * @method $this lrem(string $key, $count, $value)
 * @method $this lset(string $key, $index, $value)
 * @method $this ltrim(string $key, $start, $stop)
 * @method $this rpop(string $key)
 * @method $this rpoplpush(string $source, string $destination)
 * @method $this rpush(string $key, string ...$values)
 * @method $this rpushx(string $key, string ...$values)
 * @method $this sadd(string $key, string ...$members)
 * @method $this scard(string $key)
 ...
 * @method $this sinterstore(string $destination, array|string $keys)
 * @method $this sismember(string $key, $member)
 * @method $this smembers(string $key)
 * @method $this smismember(string $key, string ...$members)
 * @method $this smove(string $source, string $destination, string $member)
 * @method $this spop(string $key, ?int $count = null)
 * @method $this srandmember(string $key, ?int $count = null)
 * @method $this srem(string $key, string ...$member)
 ...
 * @method $this zadd(string $key, array $membersAndScoresDictionary)
 * @method $this zcard(string $key)
 * @method $this zcount(string $key, int|string $min, int|string $max)
 * @method $this zdiff(array $keys, bool $withScores = false)
 * @method $this zdiffstore(string $destination, array $keys)
 * @method $this zincrby(string $key, int $increment, string $member)
 ...
 * @method $this pfadd(string $key, string ...$elements)
