 ...
 * @method $this cfMexists(string $key)
 * @method $this cfInfo(string $key, int $capacity = -1, bool $noCreate = false, string ...$item)
 * @method $this cfInsert(string $key, int $capacity = -1, bool $noCreate = false, string ...$item)
 * @method $this cfInsertNx(string $key, int $capacity, int $bucketSize = -1, int $maxIterations = -1, int $expansion = -1)
 * @method $this cfReserve(string $key, int $iterator)
 ...
 * @method $this jsonClear(string $key, string $path, int $start, int $stop)
 * @method $this jsonArrTrim(string $key, string $path = '$')
