 ...
 * @method array             hmget(string $key, array|string ...$fields)
 ...
 * @method int               lpush(string $key, array|string ...$values)
 * @method int               lpushx(string $key, array|string ...$values)
 ...
 * @method int               rpush(string $key, array|string ...$values)
 * @method int               rpushx(string $key, array|string ...$values)
 * @method int               sadd(string $key, array|string ...$members)
 ...
 * @method int               xdel(string $key, array|string ...$id)
 ...
 * @method int               zrem(string $key, array|string ...$member)
 ...
 * @method int               pfadd(string $key, array|string ...$elements)
