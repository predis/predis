...
class KeyPrefixProcessor implements ProcessorInterface {
	...
	public function __construct($prefix)
	{
		...
		$this->commands = array(
			...
			/* ---------------- Redisearch 1.2.0 ---------------- */
			'FTCREATE'          => 'static::first',
			'FTADD'             => 'static::first',
			'FTADDHAS'          => 'static::first',
			'FTALTER'           => 'static::first',
			'FTINFO'            => 'static::first',
			'FTSEARCH'          => 'static::first',
			'FTAGGREGATE'       => 'static::first',
			'FTEXPLAIN'         => 'static::first',
			'FTDEL'             => 'static::first',
			'FTGET'             => 'static::first',
			'FTMGET'            => 'static::first',
			'FTDROP'            => 'static::first',
			'FTTAGVALS'         => 'static::first',
			'FTSUGADD'          => 'static::first',
			'FTSUGGET'          => 'static::first',
			'FTSUGDEL'          => 'static::first',
			'FTSUGLEN'          => 'static::first',
			'FTSYNADD'          => 'static::first',
			'FTSYNYPDATE'       => 'static::first',
			'FTSYNDUMP'         => 'static::first',
		);
	}
