...
class DispatcherLoopTest extends PredisTestCase
{
    ...
    public function testDispatcherLoopAgainstRedisServer()
    {
        ...
        $function01 = $this->getMockBuilder('stdClass')->setMethods(array('__invoke'))->getMock();
        ...
        $function02 = $this->getMockBuilder('stdClass')->setMethods(array('__invoke'))->getMock();
        $function02->expects($this->once())
                   ->method('__invoke')
                   ->with('02:argument');

        $function03 = $this->getMockBuilder('stdClass')->setMethods(array('__invoke'))->getMock();
    ...
    public function testDispatcherLoopAgainstRedisServerWithPrefix()
    {
        ...
        $callback = $this->getMockBuilder('stdClass')->setMethods(array('__invoke'))->getMock();
