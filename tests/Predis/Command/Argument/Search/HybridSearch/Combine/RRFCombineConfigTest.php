...
class RRFCombineConfigTest extends TestCase
{
    ...
    {
        return [
            'with WINDOW' => [(new RRFCombineConfig())->window(5), ['RRF', 2, 'WINDOW', 5]],
            'with CONSTANT' => [(new RRFCombineConfig())->rrfConstant(5), ['RRF', 2, 'CONSTANT', 5]],
            'with all' => [(new RRFCombineConfig())->window(10)->rrfConstant(5), ['RRF', 4, 'WINDOW', 10, 'CONSTANT', 5]],
        ];
    }
}
