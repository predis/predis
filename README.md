...
This project is forked of the original [Predis](https://github.com/nrk/predis), 
due to the fact that it's not maintained anymore.
...
management of projects dependencies using [Composer](http://packagist.org/about-composer) or 
...
- [Benedikt Lenzen](mailto:benedikt.lenzen@antibodies-online.com)
...
[ico-hhvm]: https://img.shields.io/hhvm/antibodies-online/predis.svg?style=flat-square
